    ...
    <div className="flex min-h-screen flex-col items-center justify-center px-4">
      <div className="mx-auto w-full max-w-2xl space-y-8 text-center">
        <div className="space-y-4">
          <h1 className="font-cal text-6xl font-bold text-stone-800 md:text-8xl dark:text-white">
            404
          </h1>
          <h2 className="font-cal text-3xl font-semibold text-stone-700 md:text-4xl dark:text-stone-200">
            Page Not Found
          </h2>
