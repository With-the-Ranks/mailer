...
export default async function OrganizationHomePage({
  ...
  return (
    <div className="w-full">
      {/* Hero Section */}
      <div className="mx-auto max-w-(--breakpoint-xl) px-4 py-12 text-center">
                ...
                <Link href={`/${email.slug}`} className="group block">
                  <div className="flex flex-col items-center gap-4 rounded-xl border bg-white p-6 transition duration-300 hover:shadow-xl md:flex-row dark:border-stone-700 dark:bg-stone-800">
                    ...
                    <div className="flex-1 text-center md:text-left">
                      ...
                      <div className="mt-4 flex flex-col items-center justify-center text-base text-stone-500 md:flex-row md:justify-start dark:text-stone-400">
